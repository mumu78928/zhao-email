...
function EmailIframe({ html, emailId }: { html: string; emailId: string }) {
  ...
  return <iframe ref={iframeRef} srcDoc={fullHtml} sandbox="allow-same-origin" className="w-full border-0 bg-transparent" style={{ height: `${height}px`, minHeight: '200px' }} title="邮件内容" />;
}
